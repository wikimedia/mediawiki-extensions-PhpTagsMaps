...
class GeoCoordinateTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testGetLatLonFromString() {
        $this->assertEquals(
                array("lat" => 55.755831, "lon" => 37.617673), MultiMaps\GeoCoordinate::getLatLonFromString("55.755831°, 37.617673°")
        );
    }
    ...
    public function testGetLatLonFromString2() {
        $this->assertEquals(
                array("lat" => 55.755831, "lon" => 37.617673), MultiMaps\GeoCoordinate::getLatLonFromString("N55.755831°, E37.617673°")
        );
    }
    ...
    public function testGetLatLonFromString3() {
        $this->assertEquals(
                array("lat" => 55.755831, "lon" => 37.617673), MultiMaps\GeoCoordinate::getLatLonFromString("55°45.34986'N, 37°37.06038'E")
        );
    }
    ...
    public function testGetLatLonFromString4() {
        $this->assertEquals(
                array("lat" => 55.755831, "lon" => 37.617673), MultiMaps\GeoCoordinate::getLatLonFromString("55°45'20.9916\"N, 37°37'3.6228\"E")
        );
    }
    ...
    public function testGetLatLonFromString5() {
        $this->assertEquals(
                array("lat" => 55.755831, "lon" => 37.617673), MultiMaps\GeoCoordinate::getLatLonFromString(" 37°37'3.6228\"E, 55°45'20.9916\" ")
        );
    }
    ...
    public function testGetLatLonFromString6() {
        $this->assertEquals(
                array("lat" => 55.755831, "lon" => 37.617673), MultiMaps\GeoCoordinate::getLatLonFromString(" 37°37'3.6228\", 55°45'20.9916\" N ")
        );
    }
    ...
    public function testGetLatLonFromString7() {
        $this->assertEquals(
                array("lat" => 55.755831, "lon" => 37.617673), MultiMaps\GeoCoordinate::getLatLonFromString("55°45'20.9916\"N, 37°37'3.6228\"")
        );
    }
    ...
    public function testGetLatLonFromString8() {
        $this->assertEquals(
                array("lat" => 55.755831, "lon" => 37.617673), MultiMaps\GeoCoordinate::getLatLonFromString("55°45'20.9916\", E37°37'3.6228\"")
        );
    }
    ...
    public function testGetLatLonFromString9() {
        $this->assertEquals(
                array("lat" => 10, "lon" => -10), MultiMaps\GeoCoordinate::getLatLonFromString(" 10  , - 10 ")
        );
    }
    ...
    public function testGetLatLonFromString10() {
        $this->assertEquals(
                array("lat" => -10, "lon" => -10), MultiMaps\GeoCoordinate::getLatLonFromString("-10°,s10 °  ")
        );
    }
    ...
    public function testGetLatLonFromString11() {
        $this->assertEquals(
                array("lat" => -10.123456, "lon" => -1.123), MultiMaps\GeoCoordinate::getLatLonFromString("s10.123456°,  -1.123°   ")
        );
    }
    ...
    public function testGetLatLonFromString12() {
        $this->assertEquals(
                array("lat" => 10.123456, "lon" => -1.123), MultiMaps\GeoCoordinate::getLatLonFromString("10.123456° N,  1.123° W  ")
        );
    }
    ...
    public function testGetLatLonFromString13() {
        $this->assertEquals(
                array("lat" => -1.123, "lon" => -10.12), MultiMaps\GeoCoordinate::getLatLonFromString("10.12° W,  1.123° s  ")
        );
    }
    ...
    public function testGetLatLonFromString14() {
        $this->assertEquals(
                array("lat" => 1.123, "lon" => -10.12), MultiMaps\GeoCoordinate::getLatLonFromString("10.12° w,  1.123°")
        );
    }
