...
$messages['de'] = array(
	...
	'multimaps-element-more-parameters' => 'Für das Kartenelement „$1“ wurden mehr Parameter übertragen als erwartet:',
...
$messages['fr'] = array(
	...
	'multimaps-element-more-parameters' => 'Davantage de paramètres qu’attendu ont été transférés pour cet élément de carte "$1":',
...
$messages['gl'] = array(
	...
	'multimaps-element-more-parameters' => 'O elemento de mapa "$1" transferiu máis parámetros dos esperados:',
...
$messages['mk'] = array(
	...
	'multimaps-element-more-parameters' => 'За овој картографски елемент „$1“ пренесе повеќе параметри од очекуваното:',
...
$messages['ru'] = array(
	...
	'multimaps-circle-wrong-number-parameters' => 'для круга должно быть определено только два параметра, координаты центра и радиус. Но {{PLURAL:$1|указан один параметр|указано $1 параметра|указано $1 параметров}}', # Fuzzy
