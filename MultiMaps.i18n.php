...
$messages['ru'] = array(
	...
	'multimaps-circle-wrong-number-parameters' => 'для круга должно быть определено только два параметра, координаты центра и радиус. Но {{PLURAL:$1|указан один параметр|указано $1 параметров|указано $1 параметра}}', # Fuzzy
	...
	'multimaps-square-wrong-number-points' => 'координаты квадрата должны состоять только из двух точек, но {{PLURAL:$1|указана одна точка|указано $1 точек|указано $1 точки}}', # Fuzzy
